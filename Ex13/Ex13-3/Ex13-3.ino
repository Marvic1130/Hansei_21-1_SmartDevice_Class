    ...
    if (client) {                             // 만약 접속이 감지되면
        ...
        if (client.available()) {             // 만약 클라이언트에서 읽을 바이트가 있다면
            ...
            if (currentLine.length() == 0) {
                ...
                if (greenState=="off") {
                    client.println("<p><a href=\"/Green/off\"><button class=\"button\">OFF</button></a></p>");
                } 
                else {
                    client.println("<p><a href=\"/Green/on\"><button class=\"button button2\">ON</button></a></p>");
                } 
    
                client.println("<p>GPIO Blue - State " + blueState + "</p>");     
                if (blueState=="off") {
                    client.println("<p><a href=\"/Blue/off\"><button class=\"button\">OFF</button></a></p>");
                }
                else {
                    client.println("<p><a href=\"/Blue/on\"><button class=\"button button2\">ON</button></a></p>");
                }
